...
const rawSuppliers: (Omit<Supplier, 'contact'> & { contact: Omit<Supplier['contact'], 'nif'> & { nif?: string } })[] = [
  ...
  },
  {
    ...
    area: 3200,
    revenue: 17.80,
    emissionsPerEmployee: 14.87,
    emissionsPerArea: 0.906,
    emissionsPerRevenue: 162.9,
    hasSBTi: false,
    certifications: ["ISO 14001"],
    yearlyProgress: [
      { year: 2021, emissions: 3200 },
      { year: 2022, emissions: 3050 },
      { year: 2023, emissions: 2900 },
    ],
    contact: {
  ...
  },
  {
    ...
    area: 2900,
    revenue: 15.20,
    emissionsPerEmployee: 13.14,
    emissionsPerArea: 0.793,
    emissionsPerRevenue: 151.3,
    hasSBTi: false,
    certifications: ["ISO 14001"],
    yearlyProgress: [
  ...
  },
  {
    ...
    area: 2200,
    revenue: 13.50,
    emissionsPerEmployee: 15.83,
    emissionsPerArea: 0.864,
    emissionsPerRevenue: 140.7,
    hasSBTi: true,
    certifications: ["ISO 14001", "SBTi Validated", "B Corp"],
    yearlyProgress: [
      { year: 2021, emissions: 2200 },
  ...
  // CONSTRUÇÃO
  {
    ...
    area: 8500,
    revenue: 24.65,
    emissionsPerEmployee: 5.83,
    emissionsPerArea: 0.124,
    emissionsPerRevenue: 42.6,
    hasSBTi: false,
    certifications: ["ISO 14001"],
    yearlyProgress: [
  ...
  },
  {
    ...
    area: 9500,
    revenue: 22.85,
    emissionsPerEmployee: 27.5,
    emissionsPerArea: 0.811,
    emissionsPerRevenue: 337.0,
    hasSBTi: false,
    certifications: [],
    yearlyProgress: [
      { year: 2021, emissions: 8400 },
      { year: 2022, emissions: 8100 },
      { year: 2023, emissions: 7700 },
    ],
    contact: {
