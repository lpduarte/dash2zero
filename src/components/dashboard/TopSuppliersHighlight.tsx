        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <CollapsibleTrigger asChild>
              <button className="ml-2 w-10 h-10 rounded-full border-2 border-success bg-white hover:bg-success/10 flex items-center justify-center transition-colors shadow-md shrink-0">
