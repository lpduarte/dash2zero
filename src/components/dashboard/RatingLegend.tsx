  ...
  const ratings = [
    {
      rating: "A",
      label: "Excelente",
      description: "Desempenho excecional em sustentabilidade. Emissões muito baixas, múltiplas certificações, compromisso SBTi validado.",
      color: "bg-success",
    ...
    },
    {
      rating: "B",
      label: "Bom",
      description: "Bom desempenho ambiental. Emissões moderadas, algumas certificações ambientais.",
      color: "bg-primary",
    ...
    },
    {
      rating: "D",
      label: "Fraco",
      description: "Desempenho abaixo da média. Emissões elevadas, ausência de certificações significativas.",
      color: "bg-danger",
    ...
    <Card className="border-primary/30 bg-gradient-to-r from-primary/5 to-accent/5">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          certificações e compromissos SBTi.
        </p>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg">
          <p className="text-xs text-muted-foreground">
            ...
            intensidade carbónica (FE), certificações ambientais (ISO 14001, etc.), 
